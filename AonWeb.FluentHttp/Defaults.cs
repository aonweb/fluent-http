...
namespace AonWeb.FluentHttp
{
    public class Defaults
    {
        ...
        {
            private readonly List<THandler> _additionalHandlers = new List<THandler>();
            ...
            {
                _additionalHandlers.AddRange(handlers);
            ...
            {
                return (Factory?.Invoke(settings) ?? Enumerable.Empty<THandler>()).Concat(_additionalHandlers);
            }
        }
    }
}